// From https://github.com/AzureADSamples/NativeClient-DotNet/blob/master/TodoListClient/CacheHelper.cs
...
namespace NuGet.Services.Operations.Azure
{
    class TokenCacheKeyElements
    {
        ...
        { get; set; }
        public bool IsUserIdDisplayable
        { get; set; }
    }
