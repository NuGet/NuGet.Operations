...
namespace NuCmd {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Collecting configuration data from all services in {0}....
        /// </summary>
        internal static string Credentials_ReportCommand_CollectingConfiguration {
            get {
                return ResourceManager.GetString("Credentials_ReportCommand_CollectingConfiguration", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string Credentials_ReportCommand_CredentialValue {
            get {
                return ResourceManager.GetString("Credentials_ReportCommand_CredentialValue", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Different Credentials used for {0}!.
        /// </summary>
        internal static string Credentials_ReportCommand_DifferentCredentialsUsedFor {
            get {
                return ResourceManager.GetString("Credentials_ReportCommand_DifferentCredentialsUsedFor", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to No differing credentials found..
        /// </summary>
        internal static string Credentials_ReportCommand_NoDiffersFound {
            get {
                return ResourceManager.GetString("Credentials_ReportCommand_NoDiffersFound", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Retrieved configuration for {0}..
        /// </summary>
        internal static string Credentials_ReportCommand_RetrievedConfigurationFor {
            get {
                return ResourceManager.GetString("Credentials_ReportCommand_RetrievedConfigurationFor", resourceCulture);
            }
        }
