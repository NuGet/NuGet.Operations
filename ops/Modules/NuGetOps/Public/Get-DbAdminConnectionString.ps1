...
.PARAMETER Database
The database to get the connection string for (Primary, Legacy or Warehouse). Defaults to "Primary"
...
function Get-DbAdminConnectionString {
    param(
        [Parameter(Mandatory=$false,Position=0)][string]$Database = "primary",
